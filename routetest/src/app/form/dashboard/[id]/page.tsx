...
export default function DashboardPage() {
    ...
    const handlechange = (e:any) => {
        ...
        else if(e.target.name === "project_duration") {     
        ...
        <div className="flex h-screen">
            ...
            <div className="flex-1 p-5">
                <div className="flex">
                    ...
                    <button className="ml-auto bg-red-500 text-white px-4 py-2 rounded" onClick={logout}>Logout</button>
                </div>
                            ...
                            <table className="w-full mt-5 border-collapse border border-black">
                                ...
                                <tbody>
                                    {projects.map((project) => (
                                        <tr key={project.project_title} className="text-center bg-blue-200 ">
                                    ...
                                    <div className="bg-white rounded-lg p-8 w-1/2">
                                        ...
                                        <div className="flex justify-end mt-4">
                                            ...
                                            <button 
                                                ...
                                                className={`px-4 py-2 rounded text-white ${isProjectTitleValid && isProjectDescriptionValid && isProjectDurationValid && isBudgetValid ? "bg-green-600 hover:bg-green-700" : "bg-gray-400 cursor-not-allowed"}`}
